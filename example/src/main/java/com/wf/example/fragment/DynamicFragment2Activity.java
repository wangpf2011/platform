 ...
 * 动态方式使用Fragment
 *
 * 填充到指定的容器LinearLayout
 * Created by wangpf on 2017/2/9.
 */

public class DynamicFragment2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.demo_fragment_dynamic2);
        initFragment();
    }
    //Button1
    ...
    private void initFragment() {
        ...
        //R.id.relative为布局
        tran.add(R.id.ll_fragment, fragment1, "fragment1").show(fragment1)
                .add(R.id.ll_fragment, fragment2, "fragment2").hide(fragment2);
        tran.commit();
    }
